...
import shutil  # Import the shutil module for file removal
from omid_openalex.preprocess.preprocess_dump import *
...
class MetaProcessorTest(unittest.TestCase):
    ...
    def test_preprocess_meta_tables(self):
        ...
        test_input_dir = self.test_data_dir  # join(self.test_data_dir, 'input')
        actual_output_dir = self.actual_output_dir  # join(self.test_data_dir, 'actual_output')
    ...
    def tearDown(self):
        # Clean up any temporary files or directories generated by the test
